...
words = "                Hey, thanks for using my gen! MADE BY ytz!#0001"
for char in words:
    sleep(0.05)
...
print("           1) Amazon Store Card Gen                       4) Xbox Gift Card Gen")
print("           2) Discord Nitro Gen + Checker                 5) Playstation Gift Card Gen")
print("           3) Netflix Gift Code Gen                       6) Other")                     
print()
...
if choice == 1:
    ...
    print("Hey none of these are checked so you gotta find your own checker ;)")
    print("")
